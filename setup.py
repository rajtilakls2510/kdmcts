...
ext_modules = [
    ...
    Extension("mujoco_envs", sources=["mujoco_envs.py"], include_dirs=["/home/rajtilak/.mujoco/mujoco210/include"], libraries=["mujoco210"], library_dirs=["/home/rajtilak/.mujoco/mujoco210/bin"]),
